...
import br.com.brunosilva.gestao_vagas.modules.jobs.useCases.ListAllJobsByFilterUseCase;
...
public class CandidateController {
    ...
    @GetMapping("/job")
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Listagem de vagas disponível para o candidato", description = "Essa função é responsável por listar todas as vagas")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
